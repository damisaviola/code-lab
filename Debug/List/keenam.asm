...
;
;void nadaC(void){
; 0000 001C void nadaC(void){

	.CSEG
_nadaC:
; .FSTART _nadaC
; 0000 001D     int i;
; 0000 001E     for(i=0;i<523;i++){
	RCALL SUBOPT_0x0
;	i -> R16,R17
_0x4:
	__CPWRN 16,17,523
...
; 0000 001F         PORTD.7=0;
	CBI  0x12,7
; 0000 0020         delay_us(956);
	__DELAY_USW 2868
; 0000 0021         PORTD.7=1;
	SBI  0x12,7
; 0000 0022         delay_us(956);
	__DELAY_USW 2868
; 0000 0023     }
	__ADDWRN 16,17,1
	RJMP _0x4
...
; .FEND
;    void nadaD(void){
; 0000 0025 void nadaD(void){
_nadaD:
; .FSTART _nadaD
; 0000 0026     int i;
; 0000 0027     for(i=0;i<294;i++){
	RCALL SUBOPT_0x0
;	i -> R16,R17
_0xB:
	__CPWRN 16,17,294
...
; 0000 0028         PORTD.7=0;
	CBI  0x12,7
; 0000 0029         delay_us(1700);
	__DELAY_USW 5100
; 0000 002A         PORTD.7=1;
	SBI  0x12,7
; 0000 002B         delay_us(1700);
	__DELAY_USW 5100
; 0000 002C     }
	__ADDWRN 16,17,1
	RJMP _0xB
...
; .FEND
;    void nadaE(void){
; 0000 002E void nadaE(void){
_nadaE:
; .FSTART _nadaE
; 0000 002F     int i;
; 0000 0030     for(i=0;i<330;i++){
	RCALL SUBOPT_0x0
;	i -> R16,R17
_0x12:
	__CPWRN 16,17,330
...
; 0000 0031         PORTD.7=0;
	CBI  0x12,7
; 0000 0032         delay_us(1515);
	__DELAY_USW 4545
; 0000 0033         PORTD.7=1;
	SBI  0x12,7
; 0000 0034         delay_us(1515);
	__DELAY_USW 4545
; 0000 0035     }
	__ADDWRN 16,17,1
	RJMP _0x12
...
; .FEND
;    void nadaF(void){
; 0000 0037 void nadaF(void){
_nadaF:
; .FSTART _nadaF
; 0000 0038     int i;
; 0000 0039     for(i=0;i<349;i++){
	RCALL SUBOPT_0x0
;	i -> R16,R17
_0x19:
	__CPWRN 16,17,349
...
; 0000 003A         PORTD.7=0;
	CBI  0x12,7
; 0000 003B         delay_us(1432);
	__DELAY_USW 4296
; 0000 003C         PORTD.7=1;
	SBI  0x12,7
; 0000 003D         delay_us(1432);
	__DELAY_USW 4296
; 0000 003E     }
	__ADDWRN 16,17,1
	RJMP _0x19
...
; .FEND
;    void nadaG(void){
; 0000 0040 void nadaG(void){
; 0000 0041     int i;
; 0000 0042     for(i=0;i<392;i++){
;	i -> R16,R17
; 0000 0043         PORTD.7=0;
; 0000 0044         delay_us(1275);
; 0000 0045         PORTD.7=1;
; 0000 0046         delay_us(1275);
; 0000 0047     }
; 0000 0048 }
;
;void nadaA(void){
; 0000 004A void nadaA(void){
_nadaA:
; .FSTART _nadaA
; 0000 004B     int i;
; 0000 004C     for(i=0;i<440;i++){
	RCALL SUBOPT_0x0
;	i -> R16,R17
_0x27:
	__CPWRN 16,17,440
...
; 0000 004D         PORTD.7=0;
	CBI  0x12,7
; 0000 004E         delay_us(1136);
	__DELAY_USW 3408
; 0000 004F         PORTD.7=1;
	SBI  0x12,7
; 0000 0050         delay_us(1136);
	__DELAY_USW 3408
; 0000 0051     }
	__ADDWRN 16,17,1
	RJMP _0x27
...
; .FEND
;void nadaB(void){
; 0000 0053 void nadaB(void){
_nadaB:
; .FSTART _nadaB
; 0000 0054     int i;
; 0000 0055     for(i=0;i<494;i++){
	RCALL SUBOPT_0x0
;	i -> R16,R17
_0x2E:
	__CPWRN 16,17,494
...
; 0000 0056         PORTD.7=0;
	CBI  0x12,7
; 0000 0057         delay_us(1012);
	__DELAY_USW 3036
; 0000 0058         PORTD.7=1;
	SBI  0x12,7
; 0000 0059         delay_us(1012);
	__DELAY_USW 3036
; 0000 005A     }
	__ADDWRN 16,17,1
	RJMP _0x2E
...
; 0000 00A5 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 00A6 
...
; 0000 00A9 // INT1: Off
; 0000 00AA // INT2: Off
; 0000 00AB MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
...
; 0000 00C9         /*
; 0000 00CA         PORTD.7=0;
; 0000 00CB         delay_us(5000);
; 0000 00CC         PORTD.7=1;
; 0000 00CD         delay_us(5000);
; 0000 00CE         */
; 0000 00CF 
; 0000 00D0         nadaA();
	RCALL _nadaA
